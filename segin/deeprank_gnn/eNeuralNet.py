...
class NeuralNet(object):
    def __init__(
        ...
        Args:
            ...
            N: number of irreducible model block
            lmax_h: highest order of spherical harmonics space
            ...
            device_name (str, optional): device name. Defaults to standard format.
            num_workers (int, optional): number of workers in dataloader. Defaults to 1.
        ...
        if pretrained_model is None:
            ...
            print(f"node feature {self.node_feature}")
            self.outdir = outdir
    ...
    def load_model(self, database, Net, database_eval):
        ...
        if self.cluster_nodes != None:
            if self.cluster_nodes == "mcl" or self.cluster_nodes == "louvain":
                ...
                # (dataset, method=self.cluster_nodes)
            else:
                raise ValueError(
        ...
        with h5py.File(fname, "w") as self.f5:
            ...
            for epoch in range(1, nepoch + 1):
                ...
                if validate is True:
                    ...
                    self.print_epoch_data("valid", epoch, _val_loss, _val_acc, t)
        ...
        with h5py.File(fname, "w") as self.f5:
            ...
            if database_test is not None:
                ...
                self.test_loader = DataLoader(
                    test_dataset, num_workers=self.num_workers
                )
    ...
    def eval(self, loader):
        ...
        for data_batch in loader:
            ...
            if data_batch.y is not None:
                ...
                #print(f"data_batch: {data_batch.y}")
    ...
    def plot_hit_rate(self, data="eval", threshold=4, mode="percentage", name=""):
        ...
        try:
            ...
            print(
                "No hit rate plot could be generated for you {} task".format(self.task)
            )
